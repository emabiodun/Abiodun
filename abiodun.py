...
def bapi(user):
	...
	try:
		...
		ua = ("Mozilla/5.0 (Linux; Android 9; itel W6004P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.73 Mobile Safari/537.36")
...
def setting_ua():
	...
	if ua =="":
		...
		print("Mozilla/5.0 (Linux; Android 9; itel W6004P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.73 Mobile Safari/537.36")
